...
#define UART_REG_RBR ( UART0_BASE_ADDR + 0x00) // Receiver Buffer Register (Read Only)
#define UART_REG_DLL ( UART0_BASE_ADDR + 0x00) // Divisor Latch (LS)
#define UART_REG_THR ( UART0_BASE_ADDR + 0x00) // Transmitter Holding Register (Write Only)
#define UART_REG_DLM ( UART0_BASE_ADDR + 0x04) // Divisor Latch (MS)
#define UART_REG_IER ( UART0_BASE_ADDR + 0x04) // Interrupt Enable Register
#define UART_REG_IIR ( UART0_BASE_ADDR + 0x08) // Interrupt Identity Register (Read Only)
#define UART_REG_FCR ( UART0_BASE_ADDR + 0x08) // FIFO Control Register (Write Only)
#define UART_REG_LCR ( UART0_BASE_ADDR + 0x0C) // Line Control Register
#define UART_REG_MCR ( UART0_BASE_ADDR + 0x10) // MODEM Control Register
#define UART_REG_LSR ( UART0_BASE_ADDR + 0x14) // Line Status Register
#define UART_REG_MSR ( UART0_BASE_ADDR + 0x18) // MODEM Status Register
#define UART_REG_SCR ( UART0_BASE_ADDR + 0x1C) // Scratch Register
