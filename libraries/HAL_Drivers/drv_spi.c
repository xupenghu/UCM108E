...
#define SCK_H   set_gpio_pin_value(UC_GPIO, 8, PIN_OUT_HIGH)
#define SCK_L   set_gpio_pin_value(UC_GPIO, 8, PIN_OUT_LOW)
#define MOSI_H  set_gpio_pin_value(UC_GPIO, 9, PIN_OUT_HIGH)
#define MOSI_L  set_gpio_pin_value(UC_GPIO, 9, PIN_OUT_LOW)
#define MISO    get_gpio_pin_value(UC_GPIO, 10)
...
{
    set_gpio_init(8, 0, 1);
    set_gpio_pin_direction(UC_GPIO, 8, PIN_OUT);
    set_gpio_init(9, 0, 1);
    set_gpio_pin_direction(UC_GPIO, 9, PIN_OUT);
    set_gpio_init(10, 0, 1);
    set_gpio_pin_direction(UC_GPIO, 10, PIN_IN);
